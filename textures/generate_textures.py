#!/usr/bin/env python3
"""
Generate joint item textures in different stages
...
def create_rolling_paper():
    """Create rolling paper with gum strip and center crease - matching joint art style"""
    img = Image.new('RGBA', (16, 16), (0, 0, 0, 0))
    draw = ImageDraw.Draw(img)

    # Color palette matching joint paper style
...
def main():
    ...
    base_path = "src/main/resources/assets/badhabits/textures/item"
