...
public class ReeferItem extends Item {
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull TooltipContext context, @Nonnull List<Component> tooltipComponents, @Nonnull TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("item.reefer.reefer.tooltip.clears_effects").withStyle(ChatFormatting.BLUE));
        tooltipComponents.add(Component.translatable("item.reefer.reefer.tooltip.applies_slowness").withStyle(ChatFormatting.RED));

        // Add durability/uses information
        int maxDamage = stack.getMaxDamage();
        int damage = stack.getDamageValue();
        int usesRemaining = maxDamage - damage;
        tooltipComponents.add(Component.translatable("item.reefer.reefer.tooltip.uses", usesRemaining, maxDamage).withStyle(ChatFormatting.GRAY));
